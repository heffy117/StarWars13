...
#define JOB_DISPLAY_ORDER_JEDI 25
...
GLOBAL_LIST_INIT(jobs_officers, list(CAPTAIN, JEDI, FIELD_COMMANDER, STAFF_OFFICER, PILOT_OFFICER, CORPORATE_LIAISON, SYNTHETIC, SILICON_AI))
GLOBAL_LIST_INIT(jobs_support, list(PILOT_OFFICER, JEDI, REQUISITIONS_OFFICER, SYNTHETIC, SILICON_AI))
...
GLOBAL_LIST_INIT(jobs_regular_all, list(CAPTAIN, JEDI, FIELD_COMMANDER, STAFF_OFFICER, PILOT_OFFICER, REQUISITIONS_OFFICER, CHIEF_SHIP_ENGINEER, \
